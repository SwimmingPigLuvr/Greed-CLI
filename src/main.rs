...
println!("{}",("         °@@@@@@@@@@@@@@@@@#°").bold());
    ...
    loop {
        ...
        println!("{}{}{}", ("PLAYER ").on_bright_green().bold(), (i).on_bright_green().bold(), (" ENTER YOUR NAME").bright_green());
        ...
        if new_name.contains("Bob") || new_name.contains("bob") {
                ...
                println!("{}", ("~ B A N A N A ~").yellow());
            } else if new_name.contains("Stuart") || new_name.contains("stuart") || new_name.contains("Stu") || new_name.contains("stu") {
                println!("{}", ("~ B A N A N A ~").yellow());
            }
    ...
    'game: loop {
        ...
        println!("\n\t{} {}: {}", 
            pvec[i].name.trim().to_ascii_uppercase().bold().on_truecolor(150, 0, 100), 
        ...
        'turn: loop {
            ...
            if keyboard_roll.trim().contains("roll") {
                println!("\n\t{} & {}", roll1.on_truecolor(0, 95, 95).bold().underline(), roll2.on_truecolor(69, 0, 69).bold().underline());
                ...
                // rolling doubles
                    ...
                    // no
                        ...
                        println!("\n{}, your total score is {}", pvec[i].name.trim().on_truecolor(3, 4, 5), pvec[i].score.bright_green());
                        pvec[i].turn_count += 1;
                        break 'turn;
                    }
                } 
                    ...
                    // no
                        ...
                        pvec[i].score += turn_scores[i];
                        println!("{}, your total score is {}", pvec[i].name.trim().on_truecolor(3, 44, 55), pvec[i].score);
                        pvec[i].turn_count += 1;
                        break 'turn;
                    }
    ...
    loop {
        ...
        if pvec[i].score >= 100 {
            ...
            'final_turn: loop {
                ...
                println!("last chance {}", final_round_players[v].name.trim().bright_green().bold());
                println!("your score is {}, {} points away!", final_round_players[v].score.yellow().bold(), high_scores[0].score - final_round_players[v].score);
